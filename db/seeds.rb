...
Breed.create(name: "Rottweiler", personality: "\"You wanna go right now?! Let's go, I'll F you UP bro!!\" Scared of leaves.", characteristics: "" )
...
Breed.create(name: "Bernese Mountain Dog", personality: "Social anxiety stems from not being able to be picked up anymore. Had a dream you yelled at them and just wants to make it up to you.", characteristics: "" )
